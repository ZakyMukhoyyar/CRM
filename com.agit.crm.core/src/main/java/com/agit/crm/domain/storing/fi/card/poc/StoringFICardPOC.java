 ...
 * @author BayuHS
 */
public class StoringFICardPOC implements EntityObject<StoringFICardPOC> {
    ...
    public int hashCode() {
        int hash = 5;
        hash = 97 * hash + Objects.hashCode(this.storingFICardPocID);
        hash = 97 * hash + Objects.hashCode(this.fiCard);
        hash = 97 * hash + Objects.hashCode(this.frameNumber);
        hash = 97 * hash + Objects.hashCode(this.fileName);
        hash = 97 * hash + Objects.hashCode(this.stage1);
        hash = 97 * hash + Objects.hashCode(this.stage2);
        hash = 97 * hash + Objects.hashCode(this.stage3);
        hash = 97 * hash + Objects.hashCode(this.stage4);
        hash = 97 * hash + Objects.hashCode(this.stage4PoinCheck5);
        hash = 97 * hash + Objects.hashCode(this.stage1PoinCheck1);
        hash = 97 * hash + Objects.hashCode(this.stage1PoinCheck2);
        hash = 97 * hash + Objects.hashCode(this.stage1PoinCheck3);
        hash = 97 * hash + Objects.hashCode(this.stage1PoinCheck4);
        hash = 97 * hash + Objects.hashCode(this.stage1PoinCheck5);
        hash = 97 * hash + Objects.hashCode(this.stage1PoinCheck6);
        hash = 97 * hash + Objects.hashCode(this.stage2PoinCheck1);
        hash = 97 * hash + Objects.hashCode(this.stage2PoinCheck2);
        hash = 97 * hash + Objects.hashCode(this.stage2PoinCheck3);
        hash = 97 * hash + Objects.hashCode(this.stage2PoinCheck4);
        hash = 97 * hash + Objects.hashCode(this.stage2PoinCheck5);
        hash = 97 * hash + Objects.hashCode(this.stage3PoinCheck1);
        hash = 97 * hash + Objects.hashCode(this.stage3PoinCheck2);
        hash = 97 * hash + Objects.hashCode(this.stage4PoinCheck1);
        hash = 97 * hash + Objects.hashCode(this.stage4PoinCheck2);
        hash = 97 * hash + Objects.hashCode(this.stage4PoinCheck3);
        hash = 97 * hash + Objects.hashCode(this.stage4PoinCheck4);
        hash = 97 * hash + Objects.hashCode(this.pathFile);
        return hash;
    }

    public void assignNewStoringPoc(StoringFICardPOC storingFICardPOC) {
        this.id = storingFICardPOC.id;
        this.storingFICardPocID = storingFICardPOC.storingFICardPocID;
        this.fiCard = storingFICardPOC.fiCard;
        this.frameNumber = storingFICardPOC.frameNumber;
        this.fileName = storingFICardPOC.fileName;
        this.stage1 = storingFICardPOC.stage1;
        this.stage2 = storingFICardPOC.stage2;
        this.stage3 = storingFICardPOC.stage3;
        this.stage4 = storingFICardPOC.stage4;
        this.stage4PoinCheck5 = storingFICardPOC.stage4PoinCheck5;
        this.stage1PoinCheck1 = storingFICardPOC.stage1PoinCheck1;
        this.stage1PoinCheck2 = storingFICardPOC.stage1PoinCheck2;
        this.stage1PoinCheck3 = storingFICardPOC.stage1PoinCheck3;
        this.stage1PoinCheck4 = storingFICardPOC.stage1PoinCheck4;
        this.stage1PoinCheck5 = storingFICardPOC.stage1PoinCheck6;
        this.stage2PoinCheck1 = storingFICardPOC.stage2PoinCheck1;
        this.stage2PoinCheck2 = storingFICardPOC.stage2PoinCheck2;
        this.stage2PoinCheck3 = storingFICardPOC.stage2PoinCheck3;
        this.stage2PoinCheck4 = storingFICardPOC.stage2PoinCheck4;
        this.stage2PoinCheck5 = storingFICardPOC.stage2PoinCheck5;
        this.stage3PoinCheck1 = storingFICardPOC.stage3PoinCheck1;
        this.stage3PoinCheck2 = storingFICardPOC.stage3PoinCheck2;
        this.stage4PoinCheck1 = storingFICardPOC.stage4PoinCheck1;
        this.stage4PoinCheck2 = storingFICardPOC.stage4PoinCheck2;
        this.stage4PoinCheck3 = storingFICardPOC.stage4PoinCheck3;
        this.stage4PoinCheck4 = storingFICardPOC.stage4PoinCheck4;
        this.pathFile = storingFICardPOC.pathFile;
        this.createdBy = storingFICardPOC.createdBy;
        this.createdDate = storingFICardPOC.createdDate;
        this.modifiedBy = storingFICardPOC.modifiedBy;
        this.modifiedDate = storingFICardPOC.modifiedDate;
        this.statusResult = storingFICardPOC.statusResult;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final StoringFICardPOC other = (StoringFICardPOC) obj;
        if (this.id != other.id) {
            return false;
        }
        return true;
    ...
    @Override
    public boolean sameIdentityAs(StoringFICardPOC other) {
